# Known Threats to the Nexus Multiverse

## Classification System

Threats are classified on a scale of 1-10:
- **Level 1-3**: Minor disturbances (local reality impact)
- **Level 4-6**: Significant threats (multi-universe impact)
- **Level 7-9**: Catastrophic threats (layer-wide impact)
- **Level 10**: Extinction-level (total multiverse collapse)
...
**Origin**: Unknown
**First detected**: Year 2750 AM
**Status**: Contained but spreading
...
**First detected**: Year 2100 AM
**Status**: Active cells in 847 universes
**Members**: ~100,000
...
- **The Shadow War** (Year 1500-1547 AM) - Universe-42's attempt to conquer Prime Reality
- **The Chrono-Collapse** (Year 2847 AM) - Time itself nearly stopped across all realities
- **The Machine Uprising** (Year 1800 AM) - Universe-1000's brief hostile period
